...
function CategoriesCard({formatter, data, type}: {
  ...
  return (
    <Card className="h-80 w-full col-span-6">
      <CardHeader>
        ...
        >
          {type === 'income' ? "Revenus" : "Dépenses"} par catégories
        </CardTitle>
      </CardHeader>
        ...
        {filteredData.length === 0 && (
          <div className="flex h-60 w-full flex-col items-center justify-center">
            ...
            <p className="text-sm text-muted-foreground text-center">
              Essayez de changer de période ou ajoutez  {type === 'income' ? "un nouveau revenu" : "une nouvelle dépense"} pour cette période
            </p>
          </div>
        )}
                ...
                return (
                  <div key={item.category} className="flex flex-col gap-2">
                    <div className="flex items-center justify-between">
                      <span className='flex items-center text-gray-4OO'>
