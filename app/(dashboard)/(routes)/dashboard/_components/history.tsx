          ...
          <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
            ...
            {!dataAvailable && (
              <Card className="flex h-[300px] flex-col items-center justify-center bg-background text-center">
                ...
                <p className="tex-sm text-muted-foreground text-center">
                  Sélectionnez une période différente ou ajoutez une nouvelle
                  transaction à celle ci
                </p>
              </Card>
            )}
          </SkeletonWrapper>
...
function CustomTooltip({ active, payload, formatter }: any) {
  ...
  return (
    <div className="min-w-[30px] rounded border bg-background p-4">
      <TooltipRow
        formatter={formatter}
        label="Revenus"
        value={income}
